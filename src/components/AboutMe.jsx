            ...
            <div className=" flex flex-col md:flex-row   md:m-5 md:gap-7 ">
              <div className="flex-1  ">
                ...
                <div className="mx-2 my-4 p-3 font-medium ">
                  <p>
                    With 6 years of experience in photography, I provide
                    striking visual content that drives business growth and
                    enhances personal projects with creative and professional
                    photography.
                  </p>
                </div>
              </div>
              ...
              <div className="flex-1  ">
                ...
                <div className="mx-2 my-4 p-3 font-medium ">
                  <p>
                    Experience the magic of ASMR through videos that combine
                    rich, calming sounds with compelling visuals, offering a
                    unique and deeply satisfying sensory journey.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex md:flex-row flex-col-reverse md:mt-24 pt-22 md:space-x-8 h-screen md:space-y-0 space-y-8">
              ...
              <div className="flex-1  ">
                ...
                >
                  ...
                  collaborations, and contributions to Pakistani television
                  shows have shaped my creative path. I prioritize values while
                  showcasing content creation&apos;s boundless opportunities
                  while adhering the principles of islam.
                </p>
              </div>
            </div>
          </div>
